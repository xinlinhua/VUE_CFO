                    ...
                    f.open = function(a) {
                        ...
                        $(".layui-layer-content").each(function() {
                            if ($(this).siblings("iframe").length ===0){
                                var iframe = '<iframe frameborder="0" width="100%" height="100%" style="position:absolute;top:0;left:0;z-index:-1;background: transparent;filter:progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);"></iframe>';
                                $(this).before(iframe);
                            }
                        })
                        return b.index
