        ...
        _getDirectionShape: function(direction) {
            ...
            switch (direction) {
                ...
                case 'left':
                    ...
                    break;
                case 'down':
                    sectorShape.rotation = [-Math.PI / 2,
                        x,
                        y
                    ];
                    break;
...
define('echarts/util/mapData/params', ['require'], function(require) {
    ...
    var mapParams = {
        ...
        'nanjing': {
            getGeoJson: function(callback) {
                require(['../../nanjing_geo'], function(md) {
                    callback(md);
                });
            }
        }
    ...
    return {
        ...
        'features': [{
            ...
            },
            {
                'type': 'Feature',
                'id': 'CAF',
                'properties': { 'name': 'Central African Restatic' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'COD',
                'properties': { 'name': 'Democratic Restatic of the Congo' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'COG',
                'properties': { 'name': 'Restatic of the Congo' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'CZE',
                'properties': { 'name': 'Czech Restatic' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'DOM',
                'properties': { 'name': 'Dominican Restatic' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'SRB',
                'properties': { 'name': 'Restatic of Serbia' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'TZA',
                'properties': { 'name': 'United Restatic of Tanzania' },
                'geometry': {
                    'type': 'Polygon',
