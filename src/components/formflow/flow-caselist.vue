 ...
 <div class="flow-case-list">
	<ul class="composite-tabs nav nav-tabs nav-tabs-icon clearfix">
		<li class="tab-li active">
			<a href="#/formflow/composite/flow-caselist/0" class="tab-li-a ">
		...
		<li class="tab-li ">
			<router-link to="/formflow/composite/flow-caselist/1" class="tab-li-a">
	...
	<div class="tab-content">
		...
		<div class="time-tabs clearfix">
			...
			<div id="time-input" style="display: block">
	...
	<div class="list-con">
		<div class="table-box">
			<el-table :data="caseList.list" style="width: 100%">
				...
				<el-table-column prop="caseStatus" label="状态" align="center">
					<template scope="scope">
						<i class="case-icon-radius" :class="getStatusImg(scope.row.caseStatus)"></i>
						<span>{{ getStatus(scope.row.caseStatus) }}</span>
					</template>
</el-table-column>
...
<el-pagination align="right" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[10, 20, 50]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="caseList.totalRow">
</el-pagination>
</div>
</div>
<rightmode message='11111'></rightmode>
</div>
...
<script>
    import WdatePicker from 'lib/My97DatePicker/WdatePicker.js'
    import rightmode from 'components/formflow/right-mode.vue'
    export default {
        components: {
            rightmode
        ...
        methods: {
            initPickerDate() {
                $('#startTime').on('focus', function() {
                    ...
                    WdatePicker({
                        dateFmt: 'yyyy-MM-dd',
                        minDate: '2000-01-01',
                        maxDate: '#F{$dp.$D(\'endTime\')||\'2099-01-01\'}'
                    });
                });
                ...
                $('#endTime').on('focus', function() {
                    ...
                    WdatePicker({
                        dateFmt: 'yyyy-MM-dd',
                        minDate: '#F{$dp.$D(\'startTime\')||\'2000-01-01\'}',
                        maxDate: '%y-%M-%d'
            ...
            getStatusImg(val) {
                ...
                var statusImg = 'case-status-' + this.caseStatusImg[val] || 'blue';
                return statusImg;
            }
